...
//  }
//
// file_put_contents ($dir.'/results.json', json_encode($response));

$fp = fopen($dir.'/subjectAreas.json', 'w');
fwrite($fp, json_encode($subjectAreas));
fclose($fp);

$fp = fopen($dir.'/expertiseAreas.json', 'w');
fwrite($fp, json_encode($expertiseAreas));
fclose($fp);

$fp = fopen($dir.'/communityPubCounts.json', 'w');
fwrite($fp, json_encode($communityPubCounts));
fclose($fp);
